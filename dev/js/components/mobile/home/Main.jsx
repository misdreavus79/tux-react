...
class MobileMain extends React.Component {
	...
	render(){
		return (
			<main role="main">
				<img src={this.props.assetsFolder + "/images/main-img-mobile.jpg"} alt="Registry Appointment Booking" />
...
if(isMobile && document.getElementById('homeContainer')){
	ReactDOM.render(<MobileMain locations={locations} assetsFolder="https://storage.googleapis.com/imp-projects/rabt/assets" />, document.getElementById('homeContainer'));
}
